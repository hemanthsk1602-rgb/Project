  ...
  return (
    <div className="min-h-screen bg-[#090D16] text-zinc-100 flex flex-col">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="rounded-2xl bg-gradient-to-b from-[#11192B] to-[#0B101C] border border-white/[0.1] p-6 sm:p-8 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 relative z-10">
            ...
            <div className="space-y-3 max-w-2xl">
              <div className="flex items-center gap-3">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-rose-500/15 border border-rose-500/30 text-rose-400 text-xs font-mono font-semibold animate-pulse">
            ...
            <div className="flex flex-col items-center lg:items-end gap-4 shrink-0">
              <div className="p-4 rounded-xl bg-[#070B13] border border-white/[0.08] text-center shadow-lg">
                ...
                <div className="text-3xl sm:text-4xl font-extrabold font-mono text-white tracking-wider">
                  ...
                  <span className="text-rose-400">{formatDigits(timeLeft.seconds)}</span>
                </div>
              </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {CURRENT_CONTEST.problems.map((problem) => {
                ...
                >
                  ...
                  <div className="mt-4 pt-3 border-t border-white/[0.06] flex items-center justify-between">
                    ...
                    <Link
                      ...
                      className="px-3 py-1 rounded bg-white/[0.05] hover:bg-brand-500 hover:text-white text-zinc-300 text-xs font-semibold transition-colors font-mono"
                    >
                      Code →
                    </Link>
                  </div>
                  ...
                  {CONTEST_STANDINGS.map((standing) => (
                    <tr
                      ...
                      className={`hover:bg-white/[0.02] transition-colors ${
                        standing.username.includes('(You)')
